...
**HospitalCore** — HospitalCore's bounded Morbidity Reporting subcontext consumes immutable diagnosis facts from this context and may cross-reference them with HospitalCore-owned registration, patient, and reference facts while processing. Its persisted and report-facing result is opaque, exposing only aggregates or opaque reporting references; this context remains the sole owner of Diagnosis Assertions and their lineage. The reporting projection does not become a diagnosis store, clinical-record layer, or direct reader of these tables.
